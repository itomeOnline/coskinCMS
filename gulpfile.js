...
const sassSrc = './themes/itome/assets/scss/**/*.+(sass|scss)';
const cssDest = './themes/itome/assets/css';
const jsSrc = "./themes/itome/assets/js/src/**/*.js";
const jsDest = "./themes/itome/assets/js/build";
...
function scripts() {
    return gulp.src(jsSrc)
      ...
      plugins: [
       css({
        dest: '/themes/itome/assets/scss/_includes/_bundle.scss',
        minified: false,
       }),
       commonjs(),
       resolve()
...
function watch() {
	...
	gulp.watch(sassSrc, gulp.series(processSass));
